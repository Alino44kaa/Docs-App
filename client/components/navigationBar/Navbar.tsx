...
const NAV_LINKS = [
  { href: '/', label: 'Главная', icon: <Tent /> },
  { href: '/books', label: 'Документация', icon: <BookMarked /> },
  { href: '/books/create', label: 'Добавить', icon: <BookPlus /> },
  { href: '/users/profile', label: 'Профиль', icon: <SquareUserRound /> },
];
